...
function buildWelcomeMessage(
  ...
  // Tailor upload guidance and "getting the best results" section by service type
  const { uploadGuidance, bestResults } = getServiceGuidance(serviceType);
...
function getServiceGuidance(serviceType: string): {
