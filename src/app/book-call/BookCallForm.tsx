    ...
    return (
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 max-w-2xl mx-auto text-center">
        ...
        <p className="text-slate-600 mb-6">
          {result.ukDateLabel} at <strong>{result.ukTimeLabel}</strong> UK time
        </p>
      ...
      {selectedDate && (
        <div className="mb-6">
          <h3 className="text-sm font-semibold uppercase tracking-wider text-slate-500 mb-3 flex items-center gap-2">
            ...
            2. Pick a time &mdash; {formatLongDateLabel(selectedDate)} (UK time)
          </h3>
        ...
        <div className="mt-6 pt-6 border-t border-slate-200">
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Briefly describe your invention or what you're hoping to get out of the call. Helps me prep — totally optional."
                disabled={submitting}
          ...
          <div className="mt-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <p className="text-sm text-slate-500">
              ...
              at <strong className="text-navy">{selectedSlot.ukTime}</strong> UK time
            </p>
