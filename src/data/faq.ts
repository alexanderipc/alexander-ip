...
export const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "From filing to grant, you're typically looking at 2 to 4 years depending on the country and the complexity of the technology. In the US, it tends to be around 2 to 3 years. Europe can stretch to 3 to 5 years. On our end, the drafting and filing stage takes around 4 to 6 weeks from the point where we have everything we need from you. The longer timeline is the examination process at the patent office — there's back and forth with the examiner, which is normal and expected.",
    category: "Process",
  },
  {
    question: "How much does a patent cost?",
    answer:
      "Our drafting fees are tiered by complexity — straightforward mechanical inventions at the lowest tier, mid-complexity for electronics, and the highest tier for software, AI, or advanced systems. Full package pricing (search + drafting + drawings + filing) is also available. Government filing fees are separate and paid by you directly to the patent office. You can see exact pricing on our services pages — everything is transparent and published upfront, because we believe the patent industry has a pricing transparency problem. You should know what you're paying before you commit.",
    category: "Pricing",
  },
  {
    question: "Why are your prices so much lower than traditional patent firms?",
    answer:
      "Because traditional firms have enormous overheads that get passed on to you. Large offices, support staff, partnership structures, junior associates doing the actual work while partners bill for supervising it. Alexander IP was founded by a specialist trained at Kilburn & Strode — a top-tier Legal 500 firm — so the quality of training and experience is the same calibre you'd get at those firms. The difference is we've stripped out all the overhead. We operate a lean practice without the large-office costs, partner profit margins, or layers of administration. You're paying for the expertise, not the office furniture.",
    category: "Pricing",
  },
  {
  ...
  },
  {
    ...
    answer:
      "You don't strictly need one — you can file without it — but we'd strongly recommend it. A patent search tells you what already exists in your space before you invest in drafting and filing. It might reveal that your exact idea has been done before, which saves you a few thousand dollars and a lot of time. Or it might show that while similar things exist, your specific approach is novel — and that information helps us draft stronger claims because we know exactly what to distinguish your invention from. Skipping the search is a bit like buying a house without a survey. You might be fine, but if there's a problem, you'll wish you'd spent the money upfront.",
    category: "Patentability",
  },
  {
    question: "What happens if my patent is rejected?",
    answer:
      "First, don't panic. Getting an office action — what most people call a 'rejection' — is a completely normal part of the process. Think of it as the patent office's opening comments in a debate about patentability. It's the start of a dialogue, not a verdict. The examiner raises objections, and then we respond with arguments, evidence, and sometimes amendments to the claims. We'll analyse exactly what the examiner has said, explain it to you in plain English, and put together a strategic response. Many patents that receive initial rejections go on to be granted. The key is knowing how to navigate that conversation effectively.",
    category: "Process",
  },
  {
    question: "Can I use AI to write my patent?",
    answer:
      "You can try, but we'd be cautious. We've seen a lot of AI-generated patent drafts at this point, and the honest truth is that editing them into something usable is often more work than starting from scratch. The problem isn't that the language sounds robotic — it's that patent claims require very precise legal and technical drafting to actually protect you. AI tools tend to produce claims that read well on the surface but are either so broad they'll be rejected or so vague they won't stop anyone from copying you. A patent that 'grants' but doesn't actually protect your invention is worse than no patent at all — because you've spent the money and time thinking you're protected when you're not.",
    category: "Process",
  },
  {
    question: "Is your founder a registered patent attorney?",
    answer:
      "Alexander IP's founder has the full training and track record of a qualified patent attorney, having trained at Kilburn & Strode LLP — a top-tier Legal 500 firm — and passed the pre-qualification exams. The 2020 exam cancellations due to COVID and a subsequent move into independent practice meant formal qualification wasn't completed. In practical terms, this hasn't been an obstacle. Over a decade in the industry, the team has taken patents from drafting through to grant across the US, UK, and Europe, working across 155+ jurisdictions via PCT. The work speaks for itself, and we're always happy to walk through our track record with anyone who wants to understand the background.",
    category: "About",
  },
  {
    question: "How do payments work?",
    answer:
      "Simple. For direct clients, it's 50% upfront to begin work and 50% on delivery. You can pay via Stripe (card) or bank transfer — whichever is easier for you. Government filing fees are always paid by you directly to the patent office. We'll walk you through exactly how to do that; it's straightforward.",
    category: "Pricing",
  },
  {
    question: "Do you offer NDAs?",
    answer:
      "Yes. Once an engagement is confirmed, we'll provide an NDA before you share any confidential details about your invention. We take this seriously — your idea is your most valuable asset at this stage, and it should be protected from the very first conversation where specifics are discussed.",
    category: "About",
  },
  {
    question: "I found you on Fiverr — can I work with you directly?",
    answer:
      "Absolutely, and many of our clients do exactly that. The work is identical — same team, same process, same quality. The benefit of working directly is there's no platform commission, which means potential savings for you, plus more flexible communication and a direct professional relationship. If you started on Fiverr and want to transition, just get in touch.",
    category: "About",
  },
  {
    question: "What technology areas do you cover?",
    answer:
      "Almost everything technical: software, AI and machine learning, communications, medical devices, consumer products, mechanical inventions, IoT, energy systems, security technology, and more. We've worked across a very wide range of subject matter over the years. The only area we generally don't handle is deep biotech or biological inventions — that's a specialist field with its own particular requirements.",
    category: "About",
  },
];
